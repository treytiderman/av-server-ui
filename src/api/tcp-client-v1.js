...
const client = {
    ...
    open: async (address, encoding) => await ws.api.send(`v1/tcp/client/open/${address}/`, { encoding }),
    send: async (address, data, encoding) => await ws.api.send(`v1/tcp/client/send/${address}/`, { data, encoding }),
    reconnect: async (address) => await ws.api.send(`v1/tcp/client/reconnect/${address}/`),
